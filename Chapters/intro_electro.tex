...
\begin{align}
	...
	Z_s^{TM} = \frac{Z_2}{\eta_0}\Biggr\rvert_{x=h} = j \frac{\cos \theta_t}{\sqrt{\epsilon_{r_2}}}\tan(\gamma_2 h \cos\theta_t).
\end{align}
...
En base a esta constante de propagación, es posible definir la velocidad de fase $Vv_p$ como
