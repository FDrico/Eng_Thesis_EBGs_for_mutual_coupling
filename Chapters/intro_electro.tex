...
\begin{align}
	...
	h = -\frac{k}{Z_s} = -k_0 \frac{R_s-jX_s}{R_s^2 + X_s^2}
\end{align}
...
Para el caso de FR4, en el rango de frecuencias de interés para este trabajo, no existe, entonces, propagación de ondas de superficie de polarización TE.
...
% Queda: 1) Terminar la demostración de TE. 2) Hacer los dibujos de TM y TE. 3) Explicar la relación con la impedancia de superficie Zs. Aplicar tanto como sea posible a cobre + FR4 (dibujos, especialmente)
