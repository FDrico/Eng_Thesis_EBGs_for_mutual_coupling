...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{Fundamentos/circuito-equivalente-celda-unitaria-divisionImpedancias.pdf}
...
De esta manera, en función de los ángulos $\theta$ y $\phi$, que representan la fase entre la entrada y salida de cada una de las líneas, se puede plantear que:

\begin{align}
\left[
\begin{matrix}\cos{\left (\frac{\theta}{2} \right )} & j \sin{\left (\frac{\theta}{2} \right )}\\
