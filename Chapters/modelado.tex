...
Resulta ilustrativo comparar el diagrama de dispersión obtenido con la gráfica del parámetro $S_{21}$ en función de la frecuencia de la figura \ref{modelo-circuital-resonancia-serie-graficos}, dado que si bien el análisis es diferente, la situación física es la misma. La comparación se observa en la figura \ref{fig:diagDisp-vs-S21}.

\begin{figure}[h]
	\centering
	\includegraphics[width=1\textwidth]{Modelado/diagDisp-vs-S21.pdf}
	\caption{Comparación del diagrama de dispersión obtenido de la ecuación \ref{eq:eq-dispersion-teorica-yang} y el obtenido mediante simulación del parámetro $S_{21}$ de la figura \ref{modelo-circuital-resonancia-serie-graficos}.}
