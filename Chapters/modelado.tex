...
Se observa que los valores son disímiles entre sí, por lo que, en el circuito, el valor de esta capacidad deberá ser obtenido por deducción en base al comportamiento en frecuencia, manteniendo estos valores como referencia o cotas aproximadas.
...
\begin{figure}[H]
	...
	\subfigure[Circuito equivalente considerando sólo el efecto de la resonancia serie.]{
		...
		\includegraphics[width=0.45\textwidth]{Fundamentos/circuito-equivalente-celda-YANG-3.pdf}}
	\hspace{0pt}
...
En la figura \ref{fig:modelo-circuital-resonancia-serie-gráficos} se pueden observar que la composición de los dos efectos más importantes analizados hasta el momento (las resonancias serie y paralela) da lugar a un comportamiento similar a transferencia del circuito analizado.
...
\begin{figure}[h]
	...
	\label{fig:modelo-circuital-resonancia-serie-gráficos}
\end{figure}
...
El circuito final, considerando resistencias, se puede observar en la figura \ref{fig:circuito-final-con-resistencias}.
...
El comportamiento del parámetro $S_{21}$ según del modelo circuital se puede comparar al simulado utilizando CST Microwave Studio en la figura \ref{fig:s12_modelo_final}.
