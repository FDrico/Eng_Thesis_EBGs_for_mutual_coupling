...
\begin{table}
	...
	\label{table:valores-dosparches-geometría}
\end{table}
...
En la tabla \ref{table:valores-parametros-finale} se lista el valor de los parámetros de diseño usados, según la nomenclatura definida en la figura \ref{fig:celda-yang}.
