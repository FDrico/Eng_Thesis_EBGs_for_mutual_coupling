...
En la tabla \ref{table:parametros-ebg-usados} se lista el valor de los parámetros de diseño usados, según la nomenclatura definida en la figura \ref{fig:celda-yang}.
...
Para ilustrar la importancia de la ubicación de una cantidad importante de celdas unitarias entre los radiadores para lograr el efecto deseado, en la figura \ref{fig:comparacion-dos-distancias} se puede observar la variación del parámetro $S$ que vincula pares de puertos enfrentados dispuestos a igual distancia. La curva roja representa el comportamiento cuando no hay celdas unitarias entre los puertos; la curva azul, cuando hay 5 filas de celdas unitarias; y la curva verde, cuando se disponen 7 filas de celdas unitarias entre los mismos.

PONER ESTA COMPARACIÓN PARA QUE SE VEA EL EFECTO REALMENTE. ESTO ES IMPORTANTE.
