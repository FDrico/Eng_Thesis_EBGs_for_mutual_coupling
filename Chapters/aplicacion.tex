...
\begin{figure}[H]
	...
	\subfigure[Diagrama de radiación de un monopolo de longitud $2\lambda/3$.]{
		...
		\includegraphics[width=0.40\textwidth]{Aplicacion/diagrad-monopolo-wikipedia.png}}
	\hspace{30pt}
	\subfigure[Diagrama de una antena monopolo.]{
		\label{fig:monopolo}
		\includegraphics[width=0.40\textwidth]{Aplicacion/Monopole_and_image_antenna.pdf}}
