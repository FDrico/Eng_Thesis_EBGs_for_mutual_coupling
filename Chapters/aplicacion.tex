...
\begin{figure}[H]
	...
	\subfigure[Variación del largo L.]{
		...
		\includegraphics[width=0.40\textwidth]{Aplicacion/VariacionLargo-UnParche.pdf}}
	\hspace{30pt}
	\subfigure[Variación del ancho W.]{
		\label{fig:1parche-varancho}
		\includegraphics[width=0.40\textwidth]{Aplicacion/VariacionAncho-UnParche.pdf}}
	\subfigure[Variación de valor del \textit{inset}.]{
		\label{fig:1parche-varinset}
		\includegraphics[width=0.40\textwidth]{Aplicacion/VariacionInset-UnParche.pdf}}
	\hspace{30pt}
	\subfigure[Antena sin cargas optimizada.]{
		\label{fig:antena-optimizada}
		\includegraphics[width=0.40\textwidth]{Aplicacion/antena-optimizada.PNG}}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{Aplicacion/FarfieldResults.pdf}
...
\begin{figure}[H]
	...
	\subfigure[Variación del largo $l'$.]{
		...
		\includegraphics[width=0.40\textwidth]{Aplicacion/VariacionAnchoLprima-UnParcheConCarga.pdf}}
	\hspace{30pt}
	\subfigure[Variación de la distancia entre la carga y el parche, $g'$.]{
		\label{fig:unparche-concarga-sinebg-varDistanciaCarga}
		\includegraphics[width=0.40\textwidth]{Aplicacion/VariacionDistanciagprimera-UnParcheConCarga.pdf}}
	\subfigure[Variación de valor de $w'$.]{
		\label{fig:unparche-concarga-sinebg-varAltoWprima}
		\includegraphics[width=0.40\textwidth]{Aplicacion/VariacionAltowprima-UnParcheConCarga.pdf}}
	\caption{Variación del parámetro $S_{11}$ del puerto en función de distintos parámetros del parche único, y antena optimizada final.}
...
\begin{figure}[H]
	...
	\subfigure[Celda unitaria propuesta por \cite{Abidin:Thesis}.]{
		\label{fig:abidin1}
		\includegraphics[width=0.40\textwidth]{Aplicacion/abidin1.png}}
	\hspace{30pt}
	\subfigure[Celda unitaria propuesta por \cite{Abidin:Thesis}.]{
		\label{fig:abidin2}
		\includegraphics[width=0.40\textwidth]{Aplicacion/abidin2.png}}
	\subfigure[Celda unitaria propuesta por \cite{Asimonis:designoptimization}.]{
		\label{fig:assimonis1}
		\includegraphics[width=0.40\textwidth]{Aplicacion/assimonis1.png}}
	\hspace{30pt}
	\subfigure[Celda unitaria propuesta por \cite{Asimonis:designoptimization}.]{
		\label{fig:assimonis2}
		\includegraphics[width=0.40\textwidth]{Aplicacion/assimonis2.png}}
	\subfigure[Celda unitaria propuesta por \cite{Asimonis:designoptimization}.]{
		\label{fig:assimonis3}
		\includegraphics[width=0.40\textwidth]{Aplicacion/assimonis3.png}}
	\subfigure[Celda unitaria propuesta por \cite{IslamAlam:CompactEBG}.]{
		\label{fig:islamalam}
		\includegraphics[width=0.40\textwidth]{Aplicacion/islamalam.png}}
	\subfigure[Celda unitaria propuesta por \cite{Kovacs:DesignOptimization}.]{
		\label{fig:kovacs}
		\includegraphics[width=0.40\textwidth]{Aplicacion/kovacs.png}}
	\caption{Variación del parámetro $S_{11}$ del puerto en función de distintos parámetros del parche único, y antena optimizada final.}
	\label{fig:simulaciones-microstrip-1parche}
\end{figure}
