...
\date{dia de Noviembre de 2018}  % Incluye la fecha al momento de compliar el documento.
\subject{}
\keywords{}
\maketitle
...
El objetivo de este trabajo es el estudio teórico y numérico del funcionamiento de las estructuras EBG (\textit{Electromagnetic Bandgap}), un subgrupo de metamateriales con capacidad de bloquear la propagación de ondas de superficie sobre sustratos \textit{microstrip}, a fin de aplicarlas a la disminución del acoplamiento mutuo entre antenas que comparten sustrato.

En primer lugar se estudia el fenómeno de generación de ondas de superficie en sustratos recubiertos por un plano de tierra, a fin de comprender el fenómeno a contrarrestar. Se desarrollan los conceptos provenientes de la óptica para la explicación del funcionamiento de las estructuras, y se utilizan las técnicas desarrolladas para cristales fotónicos a fin de lograr un acercamiento teórico al problema en microondas utilizando herramientas del electromagnetismo clásico, a través del análisis de estructuras periódicas infinitas. Para ello se utilizan distintos métodos de simulación, y se analizan los diagramas de dispersión de estructuras sencillas mediante un análisis paramétrico.

Se propone un modelo circuital de parámetros concentrados, con respuesta similar a una estructura simulada utilizando técnicas de onda completa, que permite un análisis rápido y conceptual del comportamiento de las estructuras. Además, se propone un método de simulación de la estructura bidimensional en el dominio del tiempo.

Finalmente se observa el comportamiento, frente a la inserción de geometrías EBG, de conjuntos de antenas monopolo y \textit{microstrip} que comparten sustrato.
