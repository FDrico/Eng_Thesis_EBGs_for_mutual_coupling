...
\chapter{Fundamentos de antenas de abertura}
\label{cap_fundamentos}
\lhead{Capítulo \ref{cap_fundamentos}. \emph{Fundamentos de antenas de abertura}} 
\input{./Chapters/fundamentos}

\chapter{Principios de reflectores parabólicos}
\label{cap_principios}
\lhead{Capítulo \ref{cap_principios}. \emph{Principios de reflectores parabólicos}} 
\input{./Chapters/principios}

\chapter{Estudio y diseño del alimentador}
\label{cap_estudio}
\lhead{Capítulo \ref{cap_estudio}. \emph{Estudio y diseño del alimentador}}
\input{./Chapters/estudio}
...
\chapter{Distribución de los campos en guías de onda}
\label{apendice_a}
\lhead{Apéndice \ref{apendice_a}. \emph{Distribución de los campos en guías de onda}}
\input{./Appendices/AppendixA} % Distribución de los campos en guías de ondas

\chapter{Expresiones de los campos radiados por aberturas rectangulares}
\label{apendice_b}
\lhead{Apéndice \ref{apendice_b}. \emph{Expresiones de los campos radiados por aberturas rectangulares}}
\input{./Appendices/AppendixB}	% Expresiones de los campos radiados por aberturas rectangulares

\chapter{Expresiones de los campos radiados por aberturas circulares}
\label{apendice_c}
\lhead{Apéndice \ref{apendice_c}. \emph{Expresiones de los campos radiados por aberturas circulares}}
\input{./Appendices/AppendixC} % Expresiones de los campos radiados por aberturas circulares

\chapter{Expresiones de los campos radiados por antenas parabólicas}
\label{apendice_d}
\lhead{Apéndice \ref{apendice_d}. \emph{Expresiones de los campos radiados por antenas parabólicas}}
\input{./Appendices/AppendixD} % Expresiones de los campos radiados por antenas parabólicas
...
\input{./Appendices/AppendixF} % Código de MATLAB/OCTAVE
...
\bibliography{Bibliography}  % Carga las referencias del archivo "Bibliography.bib".
