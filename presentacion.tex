...
\section{Fundamentos de EBGs}
	...
	\subsection{Bragg, Bloch-Floquet y espacio recíproco}
		...
		\only<2>{
			...
			\begin{figure}[h]
				\centering
				\includegraphics[width=0.9\textwidth]{Presentacion/brillioun-1d.pdf}
			\end{figure}
		}
		...
		\begin{frame}
			...
			\only<4>{
				\begin{figure}[h]
					\centering
					\includegraphics[width=0.70\textwidth]{Fundamentos/Fisica-DiagramaDeFase.pdf}
			\end{figure}}
		\end{frame}
		...
		\begin{frame}
			\frametitle{Análisis paramétrico de la celda}
				...
				\only<4>{\framesubtitle{Variación del ancho del sustrato}
					\centering \includegraphics[width=0.95\textwidth]{Modelado/Orlandi-3direcciones-anchoSustrato-Comparacion.pdf}
				}
		...
		\only<4>{
			...
			\begin{textblock*}{30mm}(95mm,37mm)
				\begin{block}{}
		...
		\begin{frame}
			...
			\only<1>{
				\centering Las esquinas presentan inductancia no despreciable: 
				\begin{itemize}
					\item Resonancia serie, un camino de menor impedancia, $\downarrow$ BW del \textit{bandgap}.
					\item $\downarrow f_r^p$:\;$C_g$ resuena con una inductancia mayor.
				\end{itemize}
				
				\centering \includegraphics[width=1\textwidth]{Fundamentos/circuito-equivalente-celda-YANG-6.pdf}
			}
			\only<2>{
			...
			\centering \includegraphics[width=0.85\textwidth]{Presentacion/composicion.pdf}
			}
		\end{frame}
		...
		\begin{frame}
			...
			\only<1>{
				...
				\centering \includegraphics[width=1\textwidth]{Fundamentos/circuito-equivalente-celda-YANG-5.pdf}
			}
			\only<2>{
			...
			\only<3>{
				...
				\centering \includegraphics[width=1\textwidth]{Presentacion/circuito-equivalente-celda-YANG-4.pdf}
			}
			\only<4>{
		...
		\begin{frame}
			...
			\centering
			\includegraphics[width=0.8\textwidth]{Modelado/TiposDePixel.pdf}
		\end{frame}
		...
		\begin{frame}
			...
			\begin{textblock*}{30mm}(80mm,75mm)
				\begin{block}{}
		...
		\begin{frame}
			...
			\centering \includegraphics[width=0.7\textwidth]{Modelado/ProcesoProfundidad.pdf}
