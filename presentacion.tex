			...
			\only<1>{\frametitle{Teorema de Bloch-Floquet}
				\begin{columns}
					\column{.60\textwidth}
						...
						\centering \includegraphics[width=1\textwidth]{Fundamentos/periodico-geometria.pdf}
		...
		\begin{frame}
			...
			\begin{itemize}
				...
				\item La obtención de resultados analíticos en el análisis de estructuras EBG de tecnología \textit{microstrip} es casi imposible. Se utilizan técnicas numéricas, \textbf{simulaciones de onda completa}, que \textbf{requieren mucho tiempo}. Se presentaron dos alternativas:
					\begin{itemize}
						\item \textbf{Modelado circuital}, cuyas sucesivas mejoras deriva en un modelo de líneas de transmisión.
						\item \textbf{Modelado con variación de TLM bidimensional}. Bajo costo computacional. Implementación compleja.
					\end{itemize}
