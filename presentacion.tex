...
\section{Fundamentos de EBGs}
	...
	\subsection{Bragg, Bloch-Floquet y espacio recíproco}
		...
		\begin{frame}
		\frametitle{Teorema de Bloch-Floquet}
		...
		\only<3,4,5>{
			...
			\begin{figure}[h]
				\centering
				\includegraphics[width=0.9\textwidth]{Presentacion/dispersion-ejemplo-1.pdf}
			\end{figure}
		}
		...
		\only<4>{
			...
			\begin{figure}[h]
				\centering
				\includegraphics[width=0.9\textwidth]{Presentacion/dispersion-ejemplo-2.pdf}
			\end{figure}
		}
		...
		\only<5>{
			...
			\begin{figure}[h]
				\centering
				\includegraphics[width=0.9\textwidth]{Presentacion/dispersion-ejemplo-3.pdf}
			\end{figure}
		}
		...
		\only<6,7>{
			...
			\begin{figure}[h]
				\centering
				\includegraphics[width=0.9\textwidth]{Presentacion/dispersion-ejemplo-4.pdf}
			\end{figure}
		}
		...
		\only<7>{
			...
			\begin{figure}[h]
				\centering
				\includegraphics[width=0.9\textwidth]{Presentacion/dispersion-ejemplo-5.pdf}
			\end{figure}
