...
\section{Modelado numérico de estructuras EBG}
		...
		\begin{frame}
			...
			\begin{tabular}{>{\centering\bfseries}m{0.8in} >{\centering}m{0.2in} >{\centering}m{2in} >{\centering\arraybackslash}m{1in}}
				...
				{\color{red}FDTD} & \centering {\color{red}t} & \centering {\color{red}Banda ancha. Resonantes (autovalores).} & {\color{red}\textit{CST}}\\
		...
		\begin{frame}
			\frametitle{Análisis paramétrico de la celda}
				\only<1>{\framesubtitle{Variación del ancho del puente}
					...
					\begin{textblock*}{37mm}(85mm,5mm)
						\centering
						\includegraphics[width=\textwidth]{Presentacion/orlandi-celda-puentesAncho.pdf}
					\end{textblock*}
				}
				\only<2>{\framesubtitle{Variación del largo del puente}
					...
					\begin{textblock*}{30mm}(85mm,5mm)
						\centering
						\includegraphics[width=\textwidth]{Presentacion/orlandi-celda-puentes.pdf}
					\end{textblock*}
				}
...
\subsection{Celda de Yang: Modelo circuital}
		...
		\only<2>{
			...
			\begin{tabular}{ c c c }
				\toprule
				\small
				Kim, Shutt-Ainé & \small C. Paul & \small\textit{Ansys Q3D Extractor}\\ 
				\midrule
